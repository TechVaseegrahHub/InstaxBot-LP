            ...
            <div className="px-6 h-[65px] flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-4">
                  <motion.a
                    href="https://app.instaxbot.com/login"
                    target="_blank"
            ...
            {isMobileMenuOpen && (
              ...
              >
                <div className="px-2 pt-2 pb-3 space-y-1">
                  ...
                  <div className="flex flex-col space-y-2 pt-4 px-1">
                    <motion.a
                      href="https://app.instaxbot.com/login"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full text-center px-6 py-3 rounded-lg border border-gray-800 text-gray-800 font-medium hover:bg-gray-800 hover:text-white"
                    ...
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full text-center px-6 py-3 rounded-lg bg-gradient-to-r from-gray-800 to-gray-900 text-white font-medium"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Sign Up
