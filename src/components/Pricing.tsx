...
const features = {
  basic: [
    { name: "Comments Automation", description: "Auto-reply to post comments" },
    { name: "Story Comments Automation", description: "Auto-reply to story comments" },
    { name: "Basic Analytics", description: "Track engagement metrics" },
    { name: "24/7 Support", description: "Get help when you need it" },
  ],
  professional: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center items-stretch gap-8 flex-wrap">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            whileHover={{ y: -5 }}
            className="relative p-1 bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl w-full max-w-md flex"
          >
            <div className="bg-white rounded-xl p-6 relative flex flex-col w-full">
              {/* Sparkle */}
              ...
              <div className="mt-6">
                <div className="flex items-baseline">
                  <span className="text-5xl font-bold">₹{plans.monthly.basic}</span>
                ...
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-4">
                  ...
                  <ul className="space-y-4">
                    {features.basic.map((feature, index) => (
                      ...
                      >
                        <div className="bg-white rounded-full p-1 shadow-sm mt-1 group-hover:bg-pink-100 transition-colors duration-200">
              ...
              {/* CTA */}
              <motion.button
                className="mt-8 w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-pink-600 hover:to-purple-700 transition-all group relative overflow-hidden"
