...
import {
  ...
  ArrowRight,
  X,
  Zap, // Added for new feature
  Repeat // Added for new feature
} from "lucide-react";
...
const features: Feature[] = [
  ...
  },
  {
    ...
    promoContent: "Instaxbot's Human Agent feature, real people can step in to handle conversations that require personal attention. Whether it's a complex query, sensitive issue, or a high-value lead, you can take over the chat instantly—ensuring a smooth, human touch whenever it's needed."
  },
  {
    icon: ShoppingCart,
  ...
  },
  {
    ...
    description: "Engage with fans by automatically responding to story replies.",
    stats: "Boost engagement by 60%",
    color: "from-cyan-500 to-blue-500",
    promoContent: "Turn your Instagram Stories into an engagement powerhouse. With Story Replies Automation, Instaxbot instantly responds to your followers' replies, making them feel heard and valued. This is perfect for running polls, Q&As, or simply acknowledging every interaction, building a stronger community around your brand."
  },
  {
    icon: Zap,
    title: "Chat to Checkout",
    description: "Enable customers to complete purchases directly within the chat.",
    stats: "25% higher conversion rate",
    color: "from-rose-500 to-red-500",
    promoContent: "Transform conversations into conversions with our Chat to Checkout feature. Customers can browse products, ask questions, and make a purchase all within the Instagram DM. By simplifying the buying process, you reduce friction and cart abandonment, leading to a significant boost in sales and customer satisfaction."
  }
];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        {/* Modified grid - changed to auto-fit for 6 items */}
