...
const Hero = () => {
  ...
  const heroImages = {
    thumbnail: "./Instaxbot_Logo.png",
    dashboard: "./Instaxbot_Logo.png",
    mockup: "./Instaxbot_Logo.png",
  };
      ...
      <div className="relative rounded-2xl overflow-hidden ">
        <div className="aspect-w-16 aspect-h-9">
          <img
            ...
            className="object-cover transform hover:scale-105 transition-transform duration-700 w-80 h-auto mx-auto"
            onError={(e) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-65px)]">
          ...
          >
            ...
            >
              <motion.button
                onClick={() =>
                  (window.location.href = "https://app.instaxbot.com/login")
                }
